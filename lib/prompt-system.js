...
- advanced_analysis with specific metrics
- jd_match object (only if job description provided) with score and feedback
- jd_recommendations array (only if job description provided)`,
  },
